...
<h1 align="center">🌟 PROJECT: REACT control gastos 
🎨</h1>


<h3 align="center">🛠️ App made with React, it is a PWA so you can install it on your phone or computer and use it as an app, it is also responsive so you can use it on any device.
</h3>
...
> 📝 This is a project made with React, it is a PWA so you can install it on your phone or computer and use it as an app, it is also responsive so you can use it on any device. It is a control of expenses, you can add expenses, delete them, edit them, and see the total of the expenses.
...
> 🌎 [DEPLOY LINK](https://react-control-gastos-1.netlify.app/ 'DEPLOY LINK')
